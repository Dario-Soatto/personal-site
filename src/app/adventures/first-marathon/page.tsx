...
export default function FirstMarathon() {
  return (
    <div className="p-6">
      ...
      <div className="max-w-3xl mx-auto">
        {/* Title Section */}
        <div className="mb-8">
          <p className="text-emphasis">04.02</p>
          <br />
          <p className="text-emphasis">First Marathon</p>
        </div>
        ...
        <div className="py-6">
          ...
          <br />
          <Image
            src="/first-marathon-route.png"
            alt="First Marathon Route Map"
            width={800}
            height={600}
          ...
          <ol className="list-decimal ml-10 space-y-1">
            <li>Turn around and run back to Stanford.</li>
            <li>Double back and take La Honda to Half Moon Bay.</li>
            <li>Run on the highway.</li>
        </ol>
          <br />
          <p>
          ...
          <Image
            src="/IMG_0119.jpg"
            alt="Upper Crystal Springs Reservoir"
            width={800}
            height={1200}
            className="w-auto h-auto max-h-96 mx-auto"
          />
